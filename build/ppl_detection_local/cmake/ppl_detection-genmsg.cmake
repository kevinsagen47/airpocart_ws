...
get_filename_component(_filename "/home/airpocart/airpocart_ws/src/ppl_detection_local/msg/Human.msg" NAME_WE)
add_custom_target(_ppl_detection_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ppl_detection" "/home/airpocart/airpocart_ws/src/ppl_detection_local/msg/Human.msg" ""
)

get_filename_component(_filename "/home/airpocart/airpocart_ws/src/ppl_detection_local/msg/Tracker.msg" NAME_WE)
add_custom_target(_ppl_detection_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ppl_detection" "/home/airpocart/airpocart_ws/src/ppl_detection_local/msg/Tracker.msg" "ppl_detection/Human:std_msgs/Header"
)
