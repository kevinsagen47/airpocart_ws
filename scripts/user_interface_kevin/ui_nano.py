...
from front_following_test import *
...
class MyWidget(QWidget):
    ...
    def navigation_2(self):
        global count_loop2,count_loop
        print(count_loop2," ",time.time())
        if(count_loop==count_loop2):
            print("YOU ONLY SEE ME ONCE~~~!!!!!<")    
