// Generated by gencpp from file teco_msgs/battery_msgs.msg
// DO NOT EDIT!


#ifndef TECO_MSGS_MESSAGE_BATTERY_MSGS_H
#define TECO_MSGS_MESSAGE_BATTERY_MSGS_H
...
struct battery_msgs_
{
  typedef battery_msgs_<ContainerAllocator> Type;
  ...
  battery_msgs_(const ContainerAllocator& _alloc)
    : PackageVoltage(0.0)
    , PackageCurrent(0.0)
    , SOHP(0.0)
    , SOCP(0.0)
  ...
  typedef boost::shared_ptr< ::teco_msgs::battery_msgs_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::teco_msgs::battery_msgs_<ContainerAllocator> const> ConstPtr;

}; // struct battery_msgs_

typedef ::teco_msgs::battery_msgs_<std::allocator<void> > battery_msgs;

typedef boost::shared_ptr< ::teco_msgs::battery_msgs > battery_msgsPtr;
typedef boost::shared_ptr< ::teco_msgs::battery_msgs const> battery_msgsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::teco_msgs::battery_msgs_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::teco_msgs::battery_msgs_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::teco_msgs::battery_msgs_<ContainerAllocator1> & lhs, const ::teco_msgs::battery_msgs_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::teco_msgs::battery_msgs_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::teco_msgs::battery_msgs_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::teco_msgs::battery_msgs_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::teco_msgs::battery_msgs_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::teco_msgs::battery_msgs_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::teco_msgs::battery_msgs_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::teco_msgs::battery_msgs_<ContainerAllocator> >
{
  ...
  static const char* value(const ::teco_msgs::battery_msgs_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf76442e7ca355905ULL;
  static const uint64_t static_value2 = 0x447f2ebc796d5598ULL;
};

template<class ContainerAllocator>
struct DataType< ::teco_msgs::battery_msgs_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::teco_msgs::battery_msgs_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::teco_msgs::battery_msgs_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::teco_msgs::battery_msgs_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::teco_msgs::battery_msgs_<ContainerAllocator>& v)
  {
...
#endif // TECO_MSGS_MESSAGE_BATTERY_MSGS_H
