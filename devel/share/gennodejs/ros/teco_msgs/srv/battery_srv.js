...
class battery_srvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type battery_srvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type battery_srvRequest
    let len;
    let data = new battery_srvRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new battery_srvRequest(null);
...
class battery_srvResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type battery_srvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type battery_srvResponse
    let len;
    let data = new battery_srvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new battery_srvResponse(null);
...
module.exports = {
  Request: battery_srvRequest,
  Response: battery_srvResponse,
  md5sum() { return 'c8b59f64747d119147a5ffdefffd3858'; },
  datatype() { return 'teco_msgs/battery_srv'; }
};
