...
namespace opencv_apps
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(MorphologyConfig &config, const MorphologyConfig &max, const MorphologyConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const MorphologyConfig &config1, const MorphologyConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, MorphologyConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const MorphologyConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, MorphologyConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const MorphologyConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const MorphologyConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, MorphologyConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MorphologyConfig::AbstractParamDescriptionConstPtr(new MorphologyConfig::ParamDescription<int>("morph_operator", "int", 0, "Morphology Operation Methods", "{'enum_description': 'An enum for Morphology Operations', 'enum': [{'srcline': 10, 'description': 'Opening', 'srcfile': '/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Opening'}, {'srcline': 11, 'description': 'Closing', 'srcfile': '/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Closing'}, {'srcline': 12, 'description': 'Gradient', 'srcfile': '/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Gradient'}, {'srcline': 13, 'description': 'Top Hat', 'srcfile': '/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Top_Hat'}, {'srcline': 14, 'description': 'Black Hat', 'srcfile': '/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'Black_Hat'}]}", &MorphologyConfig::morph_operator)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(MorphologyConfig::AbstractParamDescriptionConstPtr(new MorphologyConfig::ParamDescription<int>("morph_operator", "int", 0, "Morphology Operation Methods", "{'enum_description': 'An enum for Morphology Operations', 'enum': [{'srcline': 10, 'description': 'Opening', 'srcfile': '/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Opening'}, {'srcline': 11, 'description': 'Closing', 'srcfile': '/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Closing'}, {'srcline': 12, 'description': 'Gradient', 'srcfile': '/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Gradient'}, {'srcline': 13, 'description': 'Top Hat', 'srcfile': '/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Top_Hat'}, {'srcline': 14, 'description': 'Black Hat', 'srcfile': '/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'Black_Hat'}]}", &MorphologyConfig::morph_operator)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 10 "/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg"
      const int Morphology_Opening = 0;
//#line 11 "/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg"
      const int Morphology_Closing = 1;
//#line 12 "/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg"
      const int Morphology_Gradient = 2;
//#line 13 "/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg"
      const int Morphology_Top_Hat = 3;
//#line 14 "/home/airpocart/catkin_ws/src/opencv_apps/cfg/Morphology.cfg"
